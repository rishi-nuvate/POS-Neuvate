        ...
        <div class="card-body">
            <div class="content">
                <div class="content-header mb-4">
                    <h3 class="mb-1">Add Fit</h3>
                </div>
                <form method="post" action="{{route('fit.store')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        {!! textInputField('col-md-4', 'Fit Name', 'text', 'fit_name', 'fit_name', 'Fit Name', '', '',old('fit_name') ,'','') !!}
