...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light float-left">Central Warehouse/ Pack /</span> Create
    </h4>
    <!-- Invoice List Widget -->
            ...
            <div class="content">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        {!! textInputField('col-md-3 mt-3', 'Scan Shop No.', 'text', 'date', 'date', 'Description', '', '', '','') !!}
