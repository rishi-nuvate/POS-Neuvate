            ...
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                ...
                <table class="datatables-basic table dataTable no-footer dtr-column" id="DataTables_Table_0"
                    ...
                    <tr>
                        ...
                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                            style="width: 304px;" aria-label="Email: activate to sort column ascending">Remaining Quantity
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                    ...
                    <tr class="even">
                        ...
                        <td>
                            <div class="d-flex justify-content-start align-items-center user-name">
                                <div class="d-flex flex-column"><span
                                        class="emp_name text-truncate">Prahladnagar</span><small
                                        class="emp_post text-truncate text-muted">512</small></div>
                            </div>
                        </td>
                        <td>100</td>
                        <td>0</td>
                    ...
                    <tr class="odd">
                        ...
                        <td>
                            <div class="d-flex justify-content-start align-items-center user-name">
                                <div class="d-flex flex-column"><span
                                        class="emp_name text-truncate">Narol</span><small
                                        class="emp_post text-truncate text-muted">410</small></div>
                            </div>
                        </td>
                        <td>100</td>
                        <td>0</td>
                ...
                {!! selectField('col-md-3 mt-3', 'Allot To', 'warehouse', 'warehouse','select2 select21 form-select', [10 => 'Ten',20 => 'Twenty',30 => 'Thirty',], '', '', '', '') !!}
