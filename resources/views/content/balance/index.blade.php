...
@section('content')
    ...
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Master /</span> Balance</h4>
                    ...
                    <div class="block-ui-btn demo-inline-spacing">
                        ...
                        <div class="btn-group mb-2">
                            <button type="button" class="btn btn-label-primary dropdown-toggle" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <i class="menu-icon tf-icons ti ti-truck"></i>Opening Balance
                            </button>
                        ...
                        <div class="btn-group mb-2">
                            <button type="button" class="btn btn-label-primary dropdown-toggle" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <i class="menu-icon tf-icons ti ti-truck"></i>Closing Balance
                            </button>
                            <div class="dropdown-menu" style="">
                                <a class="dropdown-item" href=""><i
                                        class="ti ti-pencil me-1"></i>
